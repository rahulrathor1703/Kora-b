...
export function listManageableFormRegistryEntries(): FormRegistryEntry[] {
  return MANAGEABLE_FORM_KEYS.map((key) => requireFormRegistryEntry(key));
}
