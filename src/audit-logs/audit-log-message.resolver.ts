...
const ROUTE_RULES: RouteRule[] = [
  ...
  {
    method: 'POST',
    pattern: /^\/companies\/bulk-delete$/,
    module: 'crm',
    action: 'delete',
    resourceType: 'company',
    message: (actor) => `${actor} bulk-deleted companies`,
  },
  {
    method: 'POST',
  ...
  {
    method: 'PUT',
    pattern: /^\/notion\/connection$/,
    module: 'settings',
    action: 'update',
    resourceType: 'notion',
    message: (actor) => `${actor} connected Notion`,
  },
  {
    method: 'DELETE',
    pattern: /^\/notion\/connection$/,
    ...
    action: 'delete',
    resourceType: 'notion',
    message: (actor) => `${actor} disconnected Notion`,
  },
  {
    method: 'POST',
    pattern: /^\/notion\/import$/,
    module: 'crm',
    action: 'import',
    resourceType: 'notion',
    message: (actor) => `${actor} imported data from Notion`,
  },
  {
    method: 'GET',
    pattern: /^\/meetings$/,
