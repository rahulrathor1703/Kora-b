...
describe('EmailCampaignsService mailbox exclusivity', () => {
  ...
  function createService(options?: {
    ...
    const campaignIdFormatService = {
      generateUniqueCampaignPublicId: jest
        .fn<Promise<string>, [string]>()
        .mockResolvedValue('AB12345CDEF6'),
    };
    ...
    const service = new EmailCampaignsService(
      ...
      {} as never,
      {} as never,
      campaignIdFormatService as never,
    );
